...
public static partial class OptionExtensions
{
    ...
    /// <param name="whenNone">Function to generate the <typeparamref name="TOut"/> when this option has no value.</param>
    /// <returns>An instance of <typeparamref name="TOut"/> created depending on the status of the option.</returns>
    public static TOut Match<TIn, TOut>(this ValueOption<TIn> option, Func<TIn, TOut> whenSome, Func<TOut> whenNone)
        where TIn : struct =>
        option.TryGetValue(out var value) ? whenSome(value) : whenNone();
    ...
    /// <param name="whenNone">Function to generate the <typeparamref name="TOut"/> when this option has no value.</param>
    /// <returns>An Task of an instance of <typeparamref name="TOut"/> created depending on the status of the option.</returns>
    public static async Task<TOut> MatchAsync<TIn, TOut>(this ValueOption<TIn> option, Func<TIn, Task<TOut>> whenSome, Func<Task<TOut>> whenNone)
        where TIn : struct =>
        option.TryGetValue(out var value) ? await whenSome(value) : await whenNone();
    ...
    /// <param name="whenNone">Function to generate the <typeparamref name="TOut"/> when this option has no value.</param>
    /// <returns>An Task of an instance of <typeparamref name="TOut"/> created depending on the status of the option.</returns>
    public static async Task<TOut> Match<TIn, TOut>(this Task<ValueOption<TIn>> optionTask, Func<TIn, TOut> whenSome, Func<TOut> whenNone)
        where TIn : struct
    {
        var option = await optionTask;
        return option.Match(whenSome, whenNone);
    ...
    /// <param name="whenNone">Function to generate the <typeparamref name="TOut"/> when this option has no value.</param>
    /// <returns>An Task of an instance of <typeparamref name="TOut"/> created depending on the status of the option.</returns>
    public static async Task<TOut> MatchAsync<TIn, TOut>(this Task<ValueOption<TIn>> optionTask, Func<TIn, Task<TOut>> whenSome, Func<Task<TOut>> whenNone)
        where TIn : struct
    {
        var option = await optionTask;
        return await option.MatchAsync(whenSome, whenNone);
